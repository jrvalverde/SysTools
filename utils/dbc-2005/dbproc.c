 ...
 *		and saving every record converted to char-separated format.
 *
 *	Author:
 *		J. R. Valverde		(July, 27th, 2005)
 *			<jrvalverde@acm.org>
 *
 *		J. R. Valverde		(April, 19thm 1991)
 ...
 *
 *  $Id: dbproc.c,v 1.1 2005/08/03 08:02:32 root Exp $
 *  $Log: dbproc.c,v $
...
int *pos;
{
	...
	if (*field == '\0') {	/* new field: set SOL and return # */
	    *pos = j;
	    return i;
	}
    }
