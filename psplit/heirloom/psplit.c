 ...
 *
 * Jose R. Valverde, EMBnet/CNB, CSIC. Aug 2010-2013.
 *	Added support for regex context splitting.
 */
/*
...
static void usage(void)
{
    fprintf(stderr,
	    ...
	    printf("\n    psplit [-b bytes[k|m] | -l lines | -lines] [-a suffixlength]\n");
	    printf("        [-L regex] [inputfile [outputname]]\n\n");
    exit(2);
}
